...
internal static class UnsafeOverlapEmitter
{
    ...
    internal static UnsafeLayout ComputeLayout(IEnumerable<VariantInfo> variants, bool publicProperties)
    {
    ...
    {
        sb.AppendLine($"{typeName}(Kind tag)");
        sb.OpenBrace();
