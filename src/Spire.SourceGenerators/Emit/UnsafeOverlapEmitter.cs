...
internal static class UnsafeOverlapEmitter
{
    ...
    /// Fields with known unmanaged size go to the buffer; reference types go to object?
    /// dedup slots; everything else (generic T) goes to typed dedup slots.
        ...
        SourceBuilder sb, int fieldCount, List<VariantInfo> groupVariants, UnsafeLayout layout)
    {
        ...
        // Need a switch to read variant-specific values from buffer/slots
