...
- **Never weaken a test** to make it "more realistic" — if the design says the emitter should produce X, write output.cs with X.
- **Expected output.cs is hand-written**, never generated by running the emitter.
