...
| [SPIRE003](docs/rules/SPIRE003.md) | `default(T)` where T is a `[EnforceInitialization]` struct                      |
...
| [SPIRE006](docs/rules/SPIRE006.md) | Clearing array or span of `[EnforceInitialization]` struct                      |
